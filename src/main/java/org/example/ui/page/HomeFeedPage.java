...
public class HomeFeedPage extends JFrame {
    ...
    public HomeFeedPage(Connection con) {
    ...
    private JPanel createHeaderPanel() {
        ...
        try {
            // 트위터 로고 이미지 로드 및 설정
            ImageIcon logoIcon = new ImageIcon("src/main/java/org/example/ui/page/icons/twitter.png");  // 로고 이미지 파일 로드
    ...
    private JPanel createTweetPanel() {
        ...
        try {
            // 프로필 이미지 로드
            ImageIcon profileIcon = new ImageIcon("src/main/java/org/example/ui/page/icons/profileImage.png");
                ...
                if (!isClickedOnInteractionPanel(e.getPoint(), tweetPanel)) {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        TweetDetailPage detailPage = new TweetDetailPage(
                                ...
                                "src/main/java/org/example/ui/page/icons/profileImage.png",
                                "2h",
                                "0",
                                "0"
                        );
    ...
    private JLabel createIconLabel(String iconName) {
        try {
            // 원본 아이콘 이미지 로드
            ImageIcon originalIcon = new ImageIcon("src/main/java/org/example/ui/page/icons/" + iconName);
    ...
    private JPanel createInteractionLabel(String iconName, String count) {
        ...
        try {
            ...
            ImageIcon icon = new ImageIcon("src/main/java/org/example/ui/page/icons/" + iconName);
